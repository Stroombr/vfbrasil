...
const copyByLocale: Record<Locale, LocaleCopy> = {
  pt: {
    ...
    feedbackSuccess: 'Solicitação registrada com sucesso. Nossa equipe retornará em breve.',
    feedbackError: 'Não foi possível concluir o envio agora. Tente novamente em instantes.',
    submitIdle: 'Solicitar proposta via e-mail',
    submitSending: 'Enviando por e-mail...',
    whatsappCta: 'Falar no WhatsApp',
    whatsappTemplate:
      'Olá, gostaria de falar com a equipe da {brand}. Resumo do contato: Nome: {name}; Empresa: {company}; E-mail: {email}; Telefone: {phone}; Necessidade: {message}',
  },
  en: {
